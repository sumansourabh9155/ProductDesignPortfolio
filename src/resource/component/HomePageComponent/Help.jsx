      ...
      <section className="w-full bg-white pt-20 pb-7  md:pb-24">
        ...
        <div className="box-border flex flex-col items-center content-center px-2 md:px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
          ...
          <div className="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
            ...
            <p className="pt-4 pb-2 md:pb-8 m-0 leading-7 text-gray-700 border-0 border-gray-300 sm:pr-12 xl:pr-32 lg:text-lg">
        ...
        <div className="box-border flex flex-col items-center content-center px-2 md:px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:mt-8 xl:mt-6 md:flex-row max-w-7xl lg:px-16">
          ...
          <div className="box-border w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
            ...
            <p className="pt-2 md:pt-4pb-2 md:pb-8 m-0 leading-7 text-gray-700 border-0 border-gray-300 sm:pr-10 lg:text-lg">
        ...
        <!-- Image --> */}
          <div className="box-border relative w-full max-w-md px-4 mt-5 md:mt-10 mb-4 text-center bg-no-repeat bg-contain border-solid  md:max-w-none lg:mb-0 md:w-1/2">
            <img
              src={ux}
