...
const GlamorAI = () => {
  return (
    <div>
     <Navbar></Navbar>
      <section class="bg-[#903643] h-screen " style={{ color: "#903643" }}>
        <div className="">
        ...
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
          <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            <header class="mb-4 lg:mb-6 not-format">
              ...
              <h1 class="mb-4 text-3xl font-semibold leading-tight glamor text-gray-900 lg:mb-6 lg:text-4xl dark:text-black">
                Project Information (Goal)
              </h1>
            </header>
            <p class="lead glamor">
              Create a highly personalized fashion shopping experience that
              streamlines clothing selection, provides educational resources,
              and offers accurate recommendations based on individual style,
              body type, occasion, quality, size, and location, ultimately
              simplifying the entire shopping process for users.
            </p>
            <div className="flex gap-2 mt-6">
              <div>
                <h1 class="mb-4 text-xl glamor font-bold leading-tight text-gray-900 lg:mb-6 lg:text-2xl dark:text-black">
                  Work Process
                </h1>
                <p className="text-sm glamor">
            ...
            <h1 class="mb-4 glamor text-3xl font-semibold leading-tight glamor text-gray-900 lg:mb-6 lg:text-4xl dark:text-black">
              Problems User face
            </h1>
            ...
            <h1 class="mb-4 pt-8 glamor text-3xl font-semibold leading-tight glamor text-gray-900 lg:mb-6 lg:text-4xl dark:text-black">
              Solution For User
            </h1>
            <ol class=" space-y-1 text-gray-500 list-decimal list-inside dark:text-gray-400">
              <li className="glamor">
            ...
            <h1 class="mb-4 mt-8 text-3xl font-semibold leading-tight glamor text-gray-900 lg:mb-6 lg:text-4xl dark:text-black">
              Competitor Analysis
            </h1>
            <p class="lead glamor">
            ...
            <h1 class="mb-4 pt-8 glamor text-xl font-bold leading-tight text-gray-900 lg:mb-6 lg:text-2xl dark:text-black">
            ...
            <h1 class="mb-4 glamor  pt-8 text-xl font-bold leading-tight text-gray-900 lg:mb-6 lg:text-2xl dark:text-black">
            ...
            <h1 class="mt-8 glamor text-3xl font-semibold leading-tight glamor text-gray-900 lg:mb-6 lg:text-4xl dark:text-black">
              Target Audience
            </h1>
            ...
            <h1 class="mb-4 pt-8 text-3xl font-semibold leading-tight glamor text-gray-900 lg:mb-6 lg:text-4xl dark:text-black">
            ...
            <table class="table-auto w-full my-5 text-center ">
              <thead>
                <tr>
                  <th class="px-4 py-2 bg-gray-100 glamor">Country</th>
                  <th class="px-4 py-2 bg-gray-100 glamor">Date & Time</th>
                  <th class="px-4 py-2 bg-gray-100 glamor">Amount</th>
                </tr>
              </thead>
              <tbody>
                <tr class="border-b border-gray-300">
                  <td class="px-4 py-2 glamor">United States</td>
                  <td class="px-4 py-2 glamor">April 21, 2021</td>
                  <td class="px-4 py-2 ">
            ...
            <h1 class="mb-4 mt-8 glamor text-3xl font-semibold leading-tight glamor text-gray-900 lg:mb-6 lg:text-4xl dark:text-black">
            ...
            <div className="grid grid-cols-2 place-items-center bg-[#903643] ">
              <div class="max-w-sm px-8 py-4 ">
                <p className="text-[#9B4A55]  glamorwhite text-9xl  -z-10 ... -top-8 -left-8">
                  01
                </p>
                <div>
                  <a href="#">
                    <h5 class="mb-2 text-2xl glamorwhite text-white">
                      Brands collab
                    </h5>
                  </a>
                  <p class="mb-3 text-gray-300 text-sm glamorwhite">
            ...
            <ul className="list-disc pl-4 ">
              <li className="glamor">
                Use<strong className="text-black"> social media </strong>to share fashion tips
              </li>
              <li className="glamor">
              ...
              <li className="glamor">
                <strong className="text-black">Host fashion workshops</strong> and events to teach
                dressing techniques
              </li>
              <li className="glamor">
                <strong className="text-black"> Partner with clothing brands</strong> to offer
                personalized recommendations
              </li>
              <li className="glamor">
                <strong className="text-black">Start from the inside out</strong>.We will create
                informative and visually appealing content such as infographics
                and videos to educate people about dressing and your idea.
              </li>
            </ul>
          </article>
        </div>
