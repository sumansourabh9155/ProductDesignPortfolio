...
const Contact = () => {
  return (
    <div>
      <Navbar/>
      <div class="max-w-screen-md mx-auto p-5 pt-20">
        ...
        <form class="w-full">
          ...
          <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="flex justify-between w-full px-3 py-10">
              ...
              <button
                class="shadow bg-black hover:bg-indigo-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded"
                type="submit"
              >
                Send Message
              </button>
